...
describe("User APIs", () => {
    ...
    describe("POST /users/login", () => {
        ...
        it("Valid data to login", () => chai.request(server)
        ...
        it("Invalid data to login", () => chai.request(server)
            .post(`${baseRoute}/login`)
        ...
        it("User already logged in", () => chai.request(server)
            .post(`${baseRoute}/login`)
            .set('userId', userId)
            .send(validLoginData)
            .then((res) => {
    ...
    describe("POST /users/register", () => {
        ...
        it("Valid data to register", () => chai.request(server)
        ...
        it("Duplicate data to register", () => chai.request(server)
            .post(`${baseRoute}/register`)
            .send(validRegisterData)
            .then((res) => {
        ...
        it("Invalid data to register", () => chai.request(server)
            .post(`${baseRoute}/register`)
    ...
    describe("GET /users/logout", () => {
        it("Valid user logout", () => chai.request(server)
        ...
        it("Unauthorizaed Access on logout route", () => chai.request(server)
            .get(`${baseRoute}/logout`)
            .then((res) => {
